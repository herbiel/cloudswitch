"""
Django settings for cloudswitch project.
...
SECRET_KEY = 'django-insecure-)nsqba-@l0yys&9&1obxf7*1zwy=14dvrmz35nz)m&=@%3jbh@'
...
WSGI_APPLICATION = 'cloudswitch.wsgi.application'
